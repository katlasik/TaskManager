    ...
    public void showTasks(Scanner scanner) {
        ...
        if(!plannedTasks.isEmpty()) {
            ...
            for (Task task : plannedTasks) {
                System.out.println(String.format("%d. [%s] %s", i++, task.getCategory().getName(), task.getDescription()));
            }
        }
        ...
        System.out.printf("Wybrałeś zadanie %s: '[%s] %s'.", choice, chosen.getCategory().getName(), chosen.getDescription());
